...
<div  class=" side" style="padding: 3px;float: right; border-left: 1px solid gray;">
  ...
  <div class="container-fluid">
    ...
    Nous sommes une ecole en relation avec plusieurs organismes aussi sur le plan national qu'international. Nous sommes diversifies, nous travaillons en collaboration pour le progres des sciences et de la medecine veterinaire. Nos principaux partenaires sont les suivants.
        </p>
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"<?php echo base_url(); ?>main/pagination_cooperation/"+page,
   method:"GET",
   dataType:"json",
