...
$(document).ready(function() {
    ...
    dataTable = $('#users_table').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url() . 'admin/ajax_list_projet'; ?>",  
                type:"POST",
           },  
           "columnDefs":[  
                {  
...
function add_news()
{
    ...
    $('.modal-title').text('Ajout de projet'); // Set Title to Bootstrap modal title
...
function edit_news(id)
{
    ...
    $.ajax({
        url : base_url + "admin/ajax_edit_projet/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('.modal-title').text('Modification de projet'); // Set title to Bootstrap modal title
...
function save()
{
    ...
    if(save_method == 'add') {
        url = base_url + "admin/ajax_add_projet/";
    } else {
        url = base_url + "admin/ajax_update_projet/";
    }
...
function delete_news(id)
{
   ...
   Swal.fire({
      ...
      if (result.value) {
        $.ajax({
          url: base_url + 'admin/ajax_delete_projet/' + id,
          success: function(data){
            Swal.fire({
                title: 'Suppression',
